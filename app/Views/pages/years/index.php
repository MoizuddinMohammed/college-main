        ...
        <div class="row page-titles">
            ...
            <div class="col-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a href="/years/create" class="btn btn-danger d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Add <?= $title ?></a>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                        ...
                        <div class="col-md-12 col-sm-6 col-12">
                            ...
                            <div class="table-responsive print_table">                   
                                ...
                                <table id="login-table" class="table color-table inverse-table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach($years as $row):?>
                                            <tr>
                                                <td><?= $i++;?></td>
                                                <td><?= $row['year'];?></td>
                                                <td class="action">
                                                    <a href="<?= base_url('/years/edit/'.$row['year_id']) ?>" class="text-inverse p-r-10" data-toggle="tooltip" title="" data-original-title="Edit"><i class="ti-marker-alt"></i></a>
                                                    <a href="<?= base_url('/years/delete/'.$row['year_id']) ?>" class="text-inverse sa-confirm" title="" data-toggle="tooltip" data-original-title="Delete"><i class="ti-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                    </tbody>
