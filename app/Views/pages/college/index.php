        ...
        <div class="row page-titles">
            ...
            <div class="col-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a href="college/create" class="btn btn-danger d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Add <?= $title ?></a>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach($college as $row):?>
                                            <tr>
                                                ...
                                                <td><?= $row['phone'];?></td>
                                                <td class="action">
                                                    <a href="<?= base_url('college/edit/'.$row['id']) ?>" class="text-inverse p-r-10" data-toggle="tooltip" title="" data-original-title="Edit"><i class="ti-marker-alt"></i></a>
                                                    <a href="<?= base_url('college/delete/'.$row['id']) ?>" class="text-inverse sa-confirm" title="" data-toggle="tooltip" data-original-title="Delete"><i class="ti-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                    </tbody>
